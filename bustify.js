...
(function(){
    ...
    var Bustify = function( img, options ) {
        ...
        this.perspective = this.opts.perspective || '300px';
    ...
    Bustify.prototype.makeSquares = function() {
        ...
        for ( var y = 0; y < this.rows; y++ ) {
            ...
            for ( var x = 0; x < this.columns; x++ ) {
                ...
                newLink.style[ Modernizr.prefixed('transition') ] = 'all 500ms ease-out';
    ...
    Bustify.prototype.bindEvents = function(){
        ...
        // for mixed-bag transitionEnd events
        ...
        that.holder.addEventListener(transEndEventName, function(event) {
    ...
    Bustify.prototype.explode = function() {
        ...
        // TODO: Use Modernizer
        this.style[ Modernizr.prefixed('transform') ] = 'translate3d(' + randomTx + 'px, ' + randomTy + 'px, ' + randomTz + 'px)' + 'rotate3d(' + randomRx + ','+ randomRy + ',' + randomRz + ',' + randomRa + 'deg)';
    ...
    Bustify.prototype.onTransitionEnd = function() {
        ...
        // TODO USE MODERNIZER
        setTimeout(function() {
            that.style[ Modernizr.prefixed('transform') ] = 'translate3d(0,0,0)';
        }, 200);
